    ...
    value: function _generateSwaggerResponses(actionType) {
      ...
      switch (actionType) {
        ...
        case 'list':
          swaggerObject = {
            responses: {
              '200': { description: 'Success', schema: _joi2.default.array().items(this.model.getSchema ? this.model.getSchema() : {}) },
              '400': commonResponses['400'],
              '401': commonResponses['401']
            }
          };
        ...
        case 'bulkCreate':
          swaggerObject = {
            responses: {
              '201': { description: 'Success', schema: _joi2.default.array().items(this.model.getSchema ? this.model.getSchema() : {}) },
              '400': commonResponses['400'],
              '401': commonResponses['401'],
              '422': commonResponses['422']
            }
    ...
    value: function bulkCreate() {
      ...
      var routeObject = {
        ...
        config: {
          ...
          validate: { payload: _joi2.default.array().items(this.model.getCreateSchema ? this.model.getCreateSchema() : {}).label('' + this.model.options.name.plural) },

          plugins: { 'hapi-swagger': this._generateSwaggerResponses('bulkCreate') },

          handler: function handler(request, reply) {
            _this5.model.bulkCreate(request.payload, { validate: true, returning: true }).then(function (instances) {
              var mappedInstances = instances.map(function (instance) {
                return instance.toJson();
              });
